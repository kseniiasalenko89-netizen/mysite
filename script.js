...
const t = {
  en: {
    ...
    s4_desc:          "Body-centred practices that work with the nervous system, breath and unconscious patterns held in the body. Rooted in qigong and somatic awareness — helping release what talk alone cannot reach. Restores clarity, presence and inner balance.",
    ...
    r4_text:          '"You created the space for me to fully trust and open up. The massage became an inward journey — you guided my awareness to each part of the body as you worked. Thanks to the therapy throughout the retreat, I felt no back discomfort for a long time after."',
    ...
    r6_text:          '"Every morning I do the practice you gave me. Even before I open my eyes, my body already remembers it. Lightness, inspiration and joy begin to appear — exactly what was missing. So grateful for this — it works even when it\'s hard to help yourself."',
  ...
  ru: {
    ...
    s4_desc:          "Телесно-ориентированные практики, работающие с нервной системой, дыханием и неосознанными паттернами в теле. В основе — цигун и соматическое осознавание: помогают освободить то, что словами не достичь. Восстанавливают ясность, присутствие и внутренний баланс.",
    ...
    r4_text:          '"Ты создала условия, чтобы я смогла полностью довериться и раскрыться. Массаж стал путешествием внутрь — ты направляла мысли в те части тела, с которыми работала. Благодаря терапии на ретрите я долго после не чувствовала дискомфорта в спине."',
    ...
    r6_text:          '"Каждое утро делаю практику, которую ты дала. Уже с закрытыми глазами тело само её вспоминает. Появляются лёгкость, вдохновение и радость — то, чего так не хватало. Очень благодарна — инструмент работает даже тогда, когда сложно помочь себе самой."',
